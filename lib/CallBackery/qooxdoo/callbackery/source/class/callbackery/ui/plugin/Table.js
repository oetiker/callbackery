    ...
    members: {
        ...
        _addTable: function(){
            ...
            model.addListener('dataChanged',function(e){
                // it seems that dataChanged is a bit early
                // deferre the action until the thread is done
                qx.util.DeferredCall(function(){
            ...
            // we don't need this since when the popupCloses the
            // the button already fires an reload actionResponse
            //
