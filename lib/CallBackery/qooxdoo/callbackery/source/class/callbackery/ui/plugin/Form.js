        ...
        _reConfFormHandler: function(formCfg){
            ...
            formCfg.forEach(function(s){
                ...
                if (s.set) {
                    ...
                    // set readOnly of _cfg element in case it changed in reconfigure
                    if (s.set.readOnly != undefined) {
                        this._cfg.form.forEach(function(el) {
                            if (el.key == [s.key]) {
                                el.set.readOnly = s.set.readOnly;
                            }
                        }, this);
                    }
