    ...
    members: {
        ...
        _populate: function(){
            ...
            var form = this._form = new callbackery.ui.form.Auto(
                cfg.form,null,callbackery.ui.form.renderer.NoteForm,cfg.name
            );
            ...
            var that = this;
            if (this._action) {
                console.log('Form.populate(): destroying action', this._action);
            ...
            // console.log('adding action to', cfg.name);
            let parent = qx.core.Id.getQxObject(cfg.name);
            if (parent) {
                parent.addOwnedQxObject(action, 'Action');
            }
            else {
                console.warn('Parent not found:', cfg.name);
            }
