...
qx.Class.define("callbackery.ui.form.Auto", {
    ...
    construct : function(structure, layout, formRenderer) {
        ...
        structure.forEach(function(s){
            ...
            if (s.widget == 'header') {
                form.addGroupHeader(s.label,note);
                return;
            }
            ...
            switch(s.widget)
            {
                ...
                case 'selectBox':
                    ...
                    ctrl = this._boxCtrl[s.key] = new qx.data.controller.List(null, control, 'title');
                    ctrl.setDelegate({
                    ...
                    sbModel = qx.data.marshal.Json.createModel(cfg.structure ||
                    [ {
                        title : '',
                        key   : null
                    } ]);
                ...
                case 'comboBox':
                    ...
                    ctrl = this._boxCtrl[s.key] = new qx.data.controller.List(null, control);
                    sbModel = qx.data.marshal.Json.createModel(cfg.structure || []);
                    ctrl.setModel(sbModel);
                    break;
