...
qx.Class.define("callbackery.ui.plugin.ActionForm", {
     ...
     */
    construct : function(cfg,getFormData) {
        this.base(arguments);
    ...
    members: {
        ...
        _populate: function(cfg,buttonClass,getFormData){
            ...
            if (gridCfg && gridCfg.btnWidth) {
                this._grid.setColumnWidth(btnColumn, gridCfg.btnWidth);
            }
            if (gridCfg && gridCfg.descWidth) {
                this._grid.setColumnWidth(descColumn, gridCfg.descWidth);
            }
            else {
                this._grid.setColumnWidth(descColumn, 400);
            }
