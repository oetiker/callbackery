...
//        console.log('cfg=', cfg);
        ...
        if (gridCfg) {
            grid = this._grid = new qx.ui.layout.Grid(
                gridCfg.spacingX || 10,
                gridCfg.spacingY || 20
            );
        }
        else {
            grid = this._grid = new qx.ui.layout.Grid(10,20);
        }
    ...
    members: {
        ...
        _populate: function(cfg,buttonClass){
            ...
            if (gridCfg && gridCfg.btnWidth) {
                this._grid.setColumnWidth(colBtn, gridCfg.btnWidth);
            }
            if (gridCfg && gridCfg.descWidth) {
                this._grid.setColumnWidth(colDesc, gridCfg.descWidth);
            }
            else {
                this._grid.setColumnWidth(colDesc, 400);
            }
                    ...
                    switch (btCfg.action) {
                        case 'submit':
                            ...
                            var asyncCall = function(){
                                ...
                                },'processPluginData',cfg.name,{ "key": key, "formData": null });
                            };
                        ...
                        case 'cancel':
                            ...
                            break;
                        case 'popup':
                            var popup = new callbackery.ui.Popup(btCfg,null);
