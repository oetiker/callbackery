...
//                        console.log('adding button to menu, key=', btCfg.key);
                        ...
                        console.log('        added button', btnId);
                        return;
                        break;
                    case 'save':
                    case 'submitVerify':
...
//                            console.log('adding menuButton, key=', btCfg.key);
                            ...
                            console.log('        added menuButton', btnId);
                            [
                                'Enabled',
                                'Visibility',
                                'Icon',
                ...
                if (button) {
                    if (! btCfg.key) {
                        console.warn('adding button without key', btCfg);
                    }
                    let btnId = btCfg.key + 'Button'
                    let oldButton = qx.core.Id.getInstance().getQxObject(cfg.name + '/' + btnId);
                    if (oldButton) {
                    ...
                    if (plugin) {
                        ...
                        console.warn('Parent plugin not found:', cfg.name);
                    }
                }
                var action = function(){
                    var that = this;
