/**
 * Copy of Qooxdoo VirtualSelectBox to be included into Qooxdoo once battle tested.
 */
qx.Class.define("callbackery.ui.form.VirtualSelectBox",
{
  ...
  members :
  {
    ...
    setValue : function(selected) {
      // TODO: if no item is set, select the first item in the model
      // but maybe this is assuming too much ... the actual problem
      // is not even this, but trying to set the selection
      // to an item which is not in the model. ... tobi 2021-08-02
    ...
    _createChildControlImpl : function(id, hash)
    {
      ...
      switch(id)
      {
        ...
        case "atom":
          ...
          control.getChildControl('label').setWrap(false);
    ...
    */
    ...
    __updateDelegate : function(lastFilterValue)
    {
      ...
      if (this.isRich()) {
        delegate.configureItem = qx.lang.Function.bind(this._configureItemRich, this);
      }
    ...
    _applyDelegate : function(value, old)
    {
      ...
      if (this.isRich() && ! value.configureItem) {
        value.configureItem = qx.lang.Function.bind(this._configureItemRich, this);
      }
