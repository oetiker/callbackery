            ...
            formCfg.forEach(function(cfg) {
                ...
                if (labelCfg) {
                    ...
                    if (labelCfg.set) {
                        ...
                        if (labelCfg.set.toolTipText) {
                            label.setToolTipText(this.xtr(labelCfg.set.toolTipText));
                        }
                    }
                ...
                if (fieldCfg) {
                    ...
                    if (fieldCfg.set.toolTipText) {
                        field.setToolTipText(this.xtr(fieldCfg.set.toolTipText));
                    }
                    if (fieldCfg.set.placeholder) {
                        field.setPlaceholder(this.xtr(fieldCfg.set.placeholder));
                    }
                    var event;
