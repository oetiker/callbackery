...
qx.Class.define("callbackery.ui.Login", {
    ...
    construct : function() {
        ...
        username.getContentElement().setAttribute("name", "username");
        ...
        password.getContentElement().setAttribute("name", "password");
        ...
        var who = '';
        if ( cfg.hide_op != 'yes'){
            who = '<br/>created by <a href="http://www.oetiker.ch/" style="color: #444;" target="o+p">OETIKER+PARTNER AG</a>';
        }
        this.add(new qx.ui.basic.Label(this.tr('release %1, %2%3','#VERSION#','#DATE#',who)).set({
            textColor : '#444',
            rich : true
        }), {
            row    : 5,
