package CallBackery::PluginForm;
...
use Mojo::Base 'CallBackery::Plugin';

=head1 ATTRIBUTES

The attributes of the L<CallBackery::Plugin> class and these:
...
returns a list of action buttons to place at the bottom of the plugin screen
...
All the methods of L<CallBackery::Plugin> plus:
